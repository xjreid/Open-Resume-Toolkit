# System documentation — reserved

Future documentation in this folder should include:
...
- Dependency, asset, template, and license inventory
- Release, signing, notarization, Store, update, rollback, and compromised-key runbooks
- Backup/restore and data-recovery documentation
