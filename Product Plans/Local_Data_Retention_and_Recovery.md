...
- Provider keys are references only; secret values remain in the OS credential vault and are excluded from ordinary backup/export.
...
- Keys are never included in backup, full-data export, diagnostics, extension storage, or ordinary logs.
